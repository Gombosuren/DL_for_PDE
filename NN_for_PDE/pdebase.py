...
class NNPDE_ND:
    ...
    def __init__(self,batch_size, N, d): # d- dimension, N-number of layers
        ...
        self.x = tf.compat.v1.placeholder(tf.float64, (None, d))  # inner data
        self.x_b = tf.compat.v1.placeholder(tf.float64, (None, d))  # boundary data
...
class NNPDE2:
    def __init__(self, batch_size, N, refn):
        ...
        self.x = tf.compat.v1.placeholder(tf.float64, (None, 2)) # inner data
        self.x_b = tf.compat.v1.placeholder(tf.float64, (None, 2)) # boundary data
